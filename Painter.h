...
public:
    ...
    void printText(SDL_Renderer* renderer, TTF_Font* font, SDL_Color color, std::string s, int x, int y);

    void printText(SDL_Renderer* renderer, TTF_Font* font, SDL_Color color, std::string s, int x, int y, int w, int h);
